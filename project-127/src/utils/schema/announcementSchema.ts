import { z } from 'zod';
import { AnnouncementSource } from '@/generated/prisma';
...
export const DeleteAnnouncementSchema = z.object({
  ...
  if(data.id === "")
    ctx.addIssue({
      code: z.ZodIssueCode.custom,
      path: ["id"],
      message: "Announcement to be removed cannot be empty"
    })
...
export const DeleteAnnouncementSchemaDefault : DeleteAnnouncementSchemaType = {
  id: "",
}
